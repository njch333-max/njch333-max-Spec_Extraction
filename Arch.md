...
7. Run a builder-finalizer dispatch stage:
   ...
   - the standalone `evoca_structured_extractor.py` spike is not wired into this production path yet; its current EVOC447 work is limited to source-native JSON/QA Excel output, room-note boundary handling, group-bounded text rescue, and group-bounded raw-text fallback.
