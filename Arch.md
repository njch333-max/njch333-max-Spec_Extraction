...
7. Run a builder-finalizer dispatch stage:
   ...
   - `tests/test_evoca_end_to_end.py` provides a privacy-safe real-PDF e2e harness for Evoca: the code is committed, while customer PDFs are supplied privately through `EVOCA_E2E_PDF_DIR` or the ignored `tests/fixtures/evoca_real_pdfs` directory
