...
- **Job 38 data-loss task**: fixed page 5 `DISHWASHER` plus page 8 `TAPWARE (KITCHEN)` recovery through the v6 raw extractor boundary and production-verified on run 2370. Separate remaining backlog items still cover kitchen base-cabinetry continuation, handle summary/display, and label/note clipping.
