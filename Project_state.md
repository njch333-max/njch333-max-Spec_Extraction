...
- If formal Phase 3B acceptance is required, continue strict source-PDF QA on the remaining latest targeted overlay run (`61/2247`) instead of treating targeted readback as full signoff; `67/2250`, `64/2251`, and `62/2260` are already signed off
