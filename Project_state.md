...
- If formal Phase 3B acceptance is required, continue strict source-PDF QA on the remaining latest targeted overlay runs (`62/2246`, `61/2247`) instead of treating targeted readback as full signoff; `67/2250` and `64/2251` are already signed off
