...
SPEC_EVOCA_STRUCTURED_ENABLED = _env_flag("SPEC_EXTRACTION_ENABLE_EVOCA_STRUCTURED", "1")
SPEC_DOCLING_BUILDERS = _env_csv_set("SPEC_EXTRACTION_DOCLING_BUILDERS", "imperial,simonds,evoca,yellowwood")
...
OPENAI_REQUEST_MAX_RETRIES = int(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_MAX_RETRIES", "4"))
OPENAI_REQUEST_RETRY_BASE_SECONDS = float(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_RETRY_BASE_SECONDS", "6.0"))
OPENAI_REQUEST_RETRY_MAX_SECONDS = float(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_RETRY_MAX_SECONDS", "60.0"))
OPENAI_REQUEST_TIMEOUT_SECONDS = float(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_TIMEOUT_SECONDS", "25.0"))
