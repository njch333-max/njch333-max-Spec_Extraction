...
OPENAI_REQUEST_MIN_INTERVAL_SECONDS = float(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_MIN_INTERVAL_SECONDS", "2.0"))
OPENAI_REQUEST_MAX_RETRIES = int(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_MAX_RETRIES", "1"))
OPENAI_REQUEST_RETRY_BASE_SECONDS = float(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_RETRY_BASE_SECONDS", "3.0"))
OPENAI_REQUEST_RETRY_MAX_SECONDS = float(os.getenv("SPEC_EXTRACTION_OPENAI_REQUEST_RETRY_MAX_SECONDS", "12.0"))
